     ...
     bg-gradient-to-b from-white to-blue-700 dark:from-black dark:to-orange-700
      ...
      <div className="text-left w-full max-md:mt-20 md:w-1/2 py-12 md:py-0">
        <motion.p
          ...
          className="text-lg max-md:text-sm font-bold text-gray-900 dark:text-white flex max-md:justify-center  mb-4"
        >
            ABOUT US
        </motion.p>
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-4xl md:text-6xl font-bold flex self-center text-gray-900 dark:text-white mb-4"
        >
